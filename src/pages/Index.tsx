        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-2 text-foreground">Анна Петрова, 26</h3>
                <p className="text-secondary font-semibold mb-3">Маркетолог на удаленке</p>
                <p className="text-muted-foreground leading-relaxed">
                  "Получила образование, работаю с московскими клиентами из дома. Доход выше, чем в офисе в областном центре, а качество жизни несравнимо лучше. Открыла свою школу английского для детей."
                </p>
              </CardContent>
            </Card>
          </div>

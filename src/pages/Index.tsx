        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-bold mb-2 text-foreground">Евгения Римская, 33</h3>
                <p className="text-primary font-semibold mb-3">Репетитор английского и маркетолог</p>
                <p className="text-muted-foreground leading-relaxed">
                  "Закончила факультет Лингвистики и перевода. Помогаю получать качественное лингвистическое образование учащимся нашего города и работаю в международных проектах из дома. Живу в чистом городе, со свежим воздухом и лесом, о чем в мегаполисе могла бы только мечтать."
                </p>
              </CardContent>
            </Card>
          </div>
